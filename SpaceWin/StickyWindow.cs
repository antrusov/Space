...
namespace Blue.Windows
{
    ...
    public class StickyWindow : System.Windows.Forms.NativeWindow
    {
        ...
        /// <summary>
        /// Allow moving with other StickWindows
        /// Default value = false
        /// </summary>
        ...
        /// <summary>
        /// Allow mothing with parent window
        /// Default value = false
        /// </summary>
        public bool ChildLock
        {
            get { return childLock; }
            set { childLock = value; }
        }
        ...
        public StickyWindow(Form form, bool Parent = false, bool ChildLockOn = false)
        {
            IsParent = Parent;
